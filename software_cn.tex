...
\begin{resume_header}
  \name{李凯阳 Lee Kai Yang}
  \program{计算机专业 -- 软件工程 Honours Bachelor in Computer Science -- Software Engineering Major}
...
\begin{resume_section}{关于我 About Me}
  \begin{nospacetabbing}

    \textbf{技能 Technical Skills}  \= Go, TypeScript, React, SQL, C/C++, Python, Java, Unix/Linux, Rust (学习中)\\*
    \textbf{语言 Languages} \> 普通话（母语）、英语（流利）、 马来文（基础）\\*
    \textbf{兴趣 Interests} \> 编程, 篮球, 摄影\\*
  \end{nospacetabbing}

\end{resume_section}

\begin{resume_section}{工作经历 Work Experience}
  \begin{resume_employer}{LS Smart Machinery}{全栈开发 Full-Stack Software Engineer, Tech Team}{吉隆坡, 马来西亚}{2021年1月 - 2022年1月}
...
\begin{resume_section}{教育经历 Education}
  \begin{resume_subsection}[吉隆坡，马来西亚 (2019--现在)]{Tunku Abdul Rahman University College}
    \begin{subitems}
