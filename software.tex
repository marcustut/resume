...
\begin{resume_section}{Work Experience}
  \begin{resume_employer}{Balaena Quant}{Quantitative Developer, Infrastructure Team}{Kuala Lumpur, MY}{October 2022 - Present}
    ...
    \item Built the deployment infrastructure and continuous deployment pipeline using Kubernetes and ArgoCD
  \end{resume_employer}
