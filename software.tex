...
\begin{resume_section}{Work Experience}
  \begin{resume_employer}{Layer C}{Software Engineering Intern, Engineering Team}{Kuala Lumpur, MY}{June 2022 - November 2022}
    \item Wrote several lambdas in Go for automating internal operations.
    \item Wrote hardhat scripts to automate the deployment and operations of smart contracts.
    \item Wrote several Next.js apps for interacting with smart contracts, including marketplace, staking, etc.
  \end{resume_employer}
